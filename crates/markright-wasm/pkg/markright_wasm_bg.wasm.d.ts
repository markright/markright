...
export const extract_headings: (a: number, b: number) => [number, number, number, number];
export const extract_wikilinks: (a: number, b: number) => [number, number, number, number];
